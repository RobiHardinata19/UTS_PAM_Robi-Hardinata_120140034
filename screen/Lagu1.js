...
const Lagu1 = ({ navigation }) => {

  const [sound, setSound] = React.useState();

  async function playSound() {
    console.log('Loading Sound');
    const { sound } = await Audio.Sound.createAsync( require('../assets/IndonesiaRaya.mp3')
    );
    setSound(sound);
      ...
      <View style={styles.detail}>
         <Text style={styles.memutar}>Sedang Memutar</Text>
            <Image
                ...
                source={require('../assets/detailLagu1.png')}
            />
        <Text style={styles.judulLagu}>Indonesia Raya</Text>
        <Text style={styles.pencipta}>W.R Soepratman</Text>
      </View>
