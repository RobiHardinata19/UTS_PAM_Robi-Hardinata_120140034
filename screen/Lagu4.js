...
const Lagu4 = ({ navigation }) => {

  const [sound, setSound] = React.useState();

  async function playSound() {
    console.log('Loading Sound');
    const { sound } = await Audio.Sound.createAsync( require('../assets/TanahAirku.mp3')
    );
    setSound(sound);
      ...
      <View style={styles.detail}>
         <Text style={styles.memutar}>Sedang Memutar</Text>
            <Image
                ...
                source={require('../assets/detailLagu4.png')}
            />
        <Text style={styles.judulLagu}>Tanah Airku</Text>
        <Text style={styles.pencipta}>Ibu Sud</Text>
      </View>
